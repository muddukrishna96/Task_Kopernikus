...
def compare_frames_change_detection(prev_frame, next_frame, min_contour_area):
    ...
    for c in cnts:
        ...
        '''
        As the scores in this code does not give any significa tinformation of the percentage of similarity between two images 
        I calculated the percentage in the below line . 
        As the score or the area of the contour represent where the two images are dis-similar
        
        '''
        percentage_similarity=100 - (score/(height*width))*100

    return score, res_cnts, thresh,percentage_similarity
